...
l_Parent_0.Equipped:Connect(function() --[[ Line: 31 ]]
    ...
    v17 = true;
    l_ConfirmSprinkler_0:FindFirstChild("PlacingLabel", true).Text = ("Place %*?"):format(l_Parent_0.Name);
    v14 = os.clock();
    task.spawn(function() --[[ Line: 39 ]]
        ...
        local v19 = l_ReplicatedStorage_0.ObjectModels[l_Parent_0.Name]:Clone();
