...
local l_Table_0 = require(script:WaitForChild("Table"));
local v1 = {};
v1.__index = v1;
v1.__type = "PartCache";
local v2 = CFrame.new(0, 1000000000, 0);
local function _(v3, v4) --[[ Line: 57 ]] --[[ Name: assertwarn ]]
    if v3 == false then
        warn(v4);
    end;
end;
local function _(v6, v7) --[[ Line: 64 ]] --[[ Name: MakeFromTemplate ]]
    -- upvalues: v2 (copy)
    local v8 = v6:Clone();
    v8.CFrame = v2;
    v8.Anchored = true;
    v8.TopSurface = Enum.SurfaceType.Smooth;
    v8.BottomSurface = Enum.SurfaceType.Smooth;
    v8.CanCollide = false;
    v8.Parent = v7;
    return v8;
end;
v1.new = function(v10, v11, v12) --[[ Line: 80 ]] --[[ Name: new ]]
    -- upvalues: v1 (copy), l_Table_0 (copy), v2 (copy)
    local v13 = v11 or 5;
...
v1.GetPart = function(v24) --[[ Line: 118 ]] --[[ Name: GetPart ]]
    -- upvalues: v1 (copy), l_Table_0 (copy), v2 (copy)
    ...
    if #v24.Open == 0 then
        ...
        for _ = 1, v24.ExpansionSize do
            ...
            v30.CFrame = v2;
            v30.Anchored = true;
            v30.TopSurface = Enum.SurfaceType.Smooth;
            v30.BottomSurface = Enum.SurfaceType.Smooth;
...
v1.ReturnPart = function(v32, v33) --[[ Line: 134 ]] --[[ Name: ReturnPart ]]
    -- upvalues: v1 (copy), l_Table_0 (copy), v2 (copy)
...
v1.SetCacheParent = function(v35, v36) --[[ Line: 149 ]] --[[ Name: SetCacheParent ]]
    -- upvalues: v1 (copy)
...
v1.Expand = function(v39, v40) --[[ Line: 163 ]] --[[ Name: Expand ]]
    -- upvalues: v1 (copy), l_Table_0 (copy), v2 (copy)
...
v1.Dispose = function(v47) --[[ Line: 175 ]] --[[ Name: Dispose ]]
    -- upvalues: v1 (copy)
