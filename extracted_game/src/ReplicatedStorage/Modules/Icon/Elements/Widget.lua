...
return function(v0, v1) --[[ Line: 6 ]]
    ...
    local function v68() --[[ Line: 349 ]] --[[ Name: updateBorderSize ]]
    ...
    v0:setBehaviour("IconImage", "Image", function(v69) --[[ Line: 371 ]]
    ...
    v0.alignmentChanged:Connect(function(v71) --[[ Line: 378 ]]
    ...
    l_NumberValue_0:GetPropertyChangedSignal("Value"):Connect(function() --[[ Line: 389 ]]
