...
local v9 = {
    ...
    Damage = function() --[[ Line: 33 ]] --[[ Name: Damage ]]
        -- upvalues: v0 (copy)
        local v2 = v0.new(1.5, 4, 0.1, 0.75);
    ...
    Earthquake = function() --[[ Line: 52 ]] --[[ Name: Earthquake ]]
        -- upvalues: v0 (copy)
        local v4 = v0.new(0.6, 3.5, 2, 10);
    ...
    HandheldCamera = function() --[[ Line: 72 ]] --[[ Name: HandheldCamera ]]
        -- upvalues: v0 (copy)
        local v6 = v0.new(1, 0.25, 2, 10);
        v6.PositionInfluence = Vector3.new(0, 0, 0, 0);
        v6.RotationInfluence = Vector3.new(3, 3, 0.75, 0);
        return v6;
    end, 
    Vibration = function() --[[ Line: 82 ]] --[[ Name: Vibration ]]
        -- upvalues: v0 (copy)
        local v7 = v0.new(0.4, 20, 2, 2);
        v7.PositionInfluence = Vector3.new(0.15000000596046448, 0.15000000596046448, 0.15000000596046448, 0);
        v7.RotationInfluence = Vector3.new(1.25, 0, 4, 0);
        return v7;
    end, 
    RoughDriving = function() --[[ Line: 92 ]] --[[ Name: RoughDriving ]]
        -- upvalues: v0 (copy)
...
return (setmetatable({}, {
    __index = function(_, v11) --[[ Line: 104 ]] --[[ Name: __index ]]
        -- upvalues: v9 (copy)
        local v12 = v9[v11];
